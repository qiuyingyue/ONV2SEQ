...
def onv_preprocess(img_size = 600, csvfilename=None):
    ...
    if csvfilename is None:
        csvfilename = "noise_"+str(ovn_size)+"_0.15.csv"     #left eye: noise_onv_0.15.csv; right eye: noise_onv_0.15_right.csv
    ...
    return X, Y, index_00, index_01, index_10, index_11, coeff_00, coeff_01, coeff_10, coeff_11

def onv_convert_fromarr(I, index_00, index_01, index_10, index_11, coeff_00, coeff_01, coeff_10, coeff_11, resize=False):
...
def show_onv(onv, filename=None, noise_filepath = None):
    """onv: the onv vector for display"""
    X, Y, _,_,_,_,_,_,_,_ = onv_preprocess(csvfilename=noise_filepath)
...
def png_to_onv(file_dir, onv_filepath, noise_filepath):
    X, Y, index_00, index_01, index_10, index_11, coeff_00, coeff_01, coeff_10, coeff_11 = onv_preprocess(csvfilename=noise_filepath)
    for classname in os.listdir(file_dir):
        ...
        #for idx in range(100):
            ...
            # print (im.shape)
            #misc.imshow(im)
            onv = onv_convert_fromarr(im, index_00, index_01, index_10, index_11, coeff_00, coeff_01, coeff_10, coeff_11)
...
if __name__ == "__main__":
    png_to_onv("../data/png", "../data/testonvprocess", "noise_9936_0.15.csv")
    png_to_onv("../data/png", "../data/testonvprocess_right", "noise_9936_0.15_right.csv")
